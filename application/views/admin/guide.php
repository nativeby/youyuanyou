...
<div class="page-content">
    ...
    <!--搜索模块-->
    <form method="get" action="/admin/guide/index">
        <div class="row">
            <div class="col-xs-12">
        ...
        <div class="col-xs-12">
            <div class="table-responsive">
                <table id="sample-table-1" class="table table-striped table-bordered table-hover" align="center">
                    ...
                    <tbody>
                    <?php foreach ($all_guide_info as $k => $v): ?>
                        <tr>
                            <td><?php echo $v['id']; ?></td>
                            <td><?php echo $v['name']; ?></td>
                            <td><?php echo $v['birth']; ?></td>
                            <td><?php echo $v['origin']; ?></td>
                            <td><?php echo $v['live_city']; ?></td>
                            <td><?php echo $v['live_years']; ?></td>
...
<script type="text/javascript">
    ...
    function editStatus(id, priority) {
        var is_check = '';
        var is_check1 = '';
        var is_check2 = '';
        if (priority == 'N') {
        ...
        $("#examine_yes").click(function () {
            ...
            var prioritys = $("input[name='prioritys']:checked").val();
            if (list == null) {
                alert('请选择要更改的角色!');
                return;
            }
